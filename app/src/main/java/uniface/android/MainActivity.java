...
import uniface.android.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static boolean[] testing = new boolean[1];
    ...
    public static boolean requestPermission(Activity activity, int requestCode){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (cameraPermission != PackageManager.PERMISSION_GRANTED) {
                activity.requestPermissions(REQUEST_PERMISSIONS, requestCode);
                return false;
            }
        }
        return true;
